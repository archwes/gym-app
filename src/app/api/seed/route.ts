...
export async function POST(request: Request) {
  try {
    ...
    const exercises = [
      ...
      { name: 'Supino Reto com Halteres', muscleGroup: 'Peito', equipment: 'Halteres e Banco', description: 'Deitado no banco reto, empurre os halteres para cima com os cotovelos a 45°.', difficulty: 'Intermediário' },
      ...
      { name: 'Puxada Supinada', muscleGroup: 'Costas', equipment: 'Pulley', description: 'Sentado no pulley, puxe com pegada supinada (palmas voltadas para você).', difficulty: 'Iniciante' },
      ...
      { name: 'Remada Curvada com Barra', muscleGroup: 'Costas', equipment: 'Barra', description: 'Incline o tronco a 45°, puxe a barra em direção ao abdômen.', difficulty: 'Intermediário' },
      { name: 'Remada Unilateral com Halter', muscleGroup: 'Costas', equipment: 'Halter e Banco', description: 'Apoie um joelho e mão no banco, puxe o halter com o braço oposto.', difficulty: 'Intermediário' },
      ...
      { name: 'Elevação Frontal', muscleGroup: 'Ombros', equipment: 'Halteres', description: 'Em pé, eleve os halteres à frente do corpo até a altura dos ombros.', difficulty: 'Iniciante' },
      { name: 'Crucifixo Inverso', muscleGroup: 'Ombros', equipment: 'Halteres', description: 'Inclinado, abra os braços lateralmente focando no deltóide posterior.', difficulty: 'Intermediário' },
      { name: 'Remada Alta', muscleGroup: 'Ombros', equipment: 'Barra ou Halteres', description: 'Em pé, puxe a barra rente ao corpo até a altura do queixo.', difficulty: 'Intermediário' },
      ...
      // === BÍCEPS ===
      { name: 'Rosca Direta com Barra', muscleGroup: 'Bíceps', equipment: 'Barra', description: 'Em pé, segure a barra com pegada supinada e flexione os cotovelos.', difficulty: 'Iniciante' },
      { name: 'Rosca Alternada com Halteres', muscleGroup: 'Bíceps', equipment: 'Halteres', description: 'Em pé, flexione alternadamente um braço de cada vez com halteres.', difficulty: 'Iniciante' },
      ...
      { name: 'Rosca Scott', muscleGroup: 'Bíceps', equipment: 'Barra e Banco Scott', description: 'Apoie os braços no banco Scott e flexione com a barra EZ.', difficulty: 'Intermediário' },
      { name: 'Rosca Concentrada', muscleGroup: 'Bíceps', equipment: 'Halter', description: 'Sentado, apoie o cotovelo na coxa interna e flexione o halter.', difficulty: 'Iniciante' },
      { name: 'Rosca no Cabo', muscleGroup: 'Bíceps', equipment: 'Cabos', description: 'Em pé na polia baixa, flexione os cotovelos puxando o cabo.', difficulty: 'Iniciante' },
      { name: 'Rosca 21', muscleGroup: 'Bíceps', equipment: 'Barra', description: '7 repetições parciais inferiores, 7 superiores e 7 completas em sequência.', difficulty: 'Avançado' },
      { name: 'Rosca Inversa', muscleGroup: 'Bíceps', equipment: 'Barra', description: 'Em pé, flexione com pegada pronada (palmas para baixo) focando no braquiorradial.', difficulty: 'Intermediário' },
      ...
      { name: 'Tríceps Corda', muscleGroup: 'Tríceps', equipment: 'Cabo/Corda', description: 'No pulley com corda, estenda os cotovelos abrindo as mãos na parte final.', difficulty: 'Iniciante' },
      ...
      { name: 'Tríceps Coice', muscleGroup: 'Tríceps', equipment: 'Halter', description: 'Inclinado, estenda o cotovelo para trás segurando o halter.', difficulty: 'Iniciante' },
      { name: 'Mergulho no Banco', muscleGroup: 'Tríceps', equipment: 'Banco', description: 'Apoie as mãos no banco atrás de você e flexione os cotovelos.', difficulty: 'Iniciante' },
      ...
      { name: 'Panturrilha Sentado', muscleGroup: 'Panturrilha', equipment: 'Máquina', description: 'Sentado na máquina de panturrilha, eleve os calcanhares.', difficulty: 'Iniciante' },
      ...
      { name: 'Abdominal Infra', muscleGroup: 'Abdômen', equipment: 'Nenhum', description: 'Deitado, eleve as pernas mantendo-as estendidas.', difficulty: 'Intermediário' },
      { name: 'Abdominal na Máquina', muscleGroup: 'Abdômen', equipment: 'Máquina', description: 'Sentado na máquina, flexione o tronco contra a resistência.', difficulty: 'Iniciante' },
      { name: 'Abdominal Bicicleta', muscleGroup: 'Abdômen', equipment: 'Nenhum', description: 'Deitado, pedale no ar tocando cotovelo no joelho oposto alternadamente.', difficulty: 'Intermediário' },
      { name: 'Elevação de Pernas na Barra', muscleGroup: 'Abdômen', equipment: 'Barra Fixa', description: 'Pendurado na barra, eleve as pernas até 90° ou mais.', difficulty: 'Avançado' },
      { name: 'Abdominal Canivete', muscleGroup: 'Abdômen', equipment: 'Nenhum', description: 'Deitado, eleve simultaneamente tronco e pernas tocando os pés.', difficulty: 'Intermediário' },
      ...
      { name: 'Prancha Lateral', muscleGroup: 'Core', equipment: 'Nenhum', description: 'Apoie-se em um antebraço de lado, mantendo o corpo alinhado.', difficulty: 'Intermediário' },
      { name: 'Prancha com Rotação', muscleGroup: 'Core', equipment: 'Nenhum', description: 'Na posição de prancha, gire o tronco elevando um braço ao teto.', difficulty: 'Intermediário' },
      ...
      // === ANTEBRAÇO ===
      { name: 'Rosca de Punho', muscleGroup: 'Antebraço', equipment: 'Barra ou Halteres', description: 'Sentado, apoie os antebraços nas coxas e flexione os punhos para cima.', difficulty: 'Iniciante' },
      { name: 'Rosca de Punho Inversa', muscleGroup: 'Antebraço', equipment: 'Barra ou Halteres', description: 'Sentado com pegada pronada, estenda os punhos para cima.', difficulty: 'Iniciante' },
    ...
    const planBExercises = [
      ...
      [exerciseIds['Remada Curvada com Barra'], 4, '8-12', 90, '40kg', 1],
      [exerciseIds['Rosca Direta com Barra'], 3, '10-12', 60, '12kg', 2],
